...
if __name__ == "__main__":
    ...
    my_img2 =  cv.resize(cv.imread('./rp2.jpg', cv.IMREAD_GRAYSCALE), (0, 0), fx=0.5, fy=0.5)
    my_img3 =  cv.resize(cv.imread('./rp3.jpg', cv.IMREAD_GRAYSCALE), (0, 0), fx=0.5, fy=0.5)
    ...
    imageio.imwrite('stitch2.jpg', s2)
