...
EE5175 - Lab 7 
Date : 08/04/2024
command to run : python3 assignment_7.py
'''
...
'''
    ...
    Returns:
    - mag: Magnitude spectrum of the transformed image.
    - phase: Phase spectrum of the transformed image.
...
'''
 Inverse Discrete Fourier Transform (IDFT) function.
    ...
    Returns:
    - mag: Reconstructed image from the magnitude and phase spectra.
'''
